...
public class AppointmentsController {
    ...
    @Post
    public CreateAppointmentResponse createAppointment(Principal principal, @Body CreateAppointmentRequest request) {
    ...
    @Get
    public GetAppointmentsResponse getAppointments(Principal principal, @QueryValue(defaultValue = "0") int page) {
