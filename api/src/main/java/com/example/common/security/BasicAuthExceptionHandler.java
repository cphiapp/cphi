...
public class BasicAuthExceptionHandler extends DefaultAuthorizationExceptionHandler {

    public BasicAuthExceptionHandler(
    ...
    protected MutableHttpResponse<?> httpResponseWithStatus(HttpRequest request,
        ...
        return HttpResponse.status(UNAUTHORIZED)
                .header(WWW_AUTHENTICATE, "Basic realm=\"ECMS\"");
    }
